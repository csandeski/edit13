...
export default function BreadQuiz() {
  ...
  // Efeito para controlar o scroll quando modais estiverem abertos
  useEffect(() => {
    const shouldLockScroll = showInstructions || showLevelUpModal || showCompletionModal || showPurchaseModal

    if (shouldLockScroll) {
      // Técnica mais robusta para bloquear rolagem em dispositivos móveis
  ...
  const recipeCollections = [
    ...
    {
      id: 2,
      title: "75 Receitas de Tortas Salgadas Saudáveis",
    ...
    {
      id: 3,
      title: "80 Receitas de Pizzas Artesanais Saudáveis",
      description: "Aprenda a fazer pizzas com massa perfeita e coberturas deliciosas",
      image: "https://i.imgur.com/0rCdeA4.jpeg",
      originalPrice: 19.9,
      price: 0,
      icon: "pizza",
    ...
    {
      id: 4,
      title: "120 Receitas de Bolos, Doces e Sobremesas Saudáveis",
      description: "Doces irresistíveis para todas as ocasiões",
      image: "https://i.imgur.com/VbVgonF.jpeg",
      originalPrice: 19.9,
      price: 0,
      icon: "cake",
    ...
    {
      id: 5,
      title: "20 Receitas de Empadinhas e Empadões Artesanais Saudáveis",
      description: "Aprenda a fazer massas perfeitas e recheios suculentos",
      image: "https://i.imgur.com/3KDUgOw.jpeg",
      originalPrice: 19.9,
      price: 0,
      icon: "utensils",
    ...
    {
      id: 6,
      title: "20 Receitas de Salgados Fritos Artesanais Saudáveis",
      description: "Salgados crocantes e suculentos para festas e eventos",
      image: "https://i.imgur.com/CXooNSZ.jpeg",
      originalPrice: 19.9,
      price: 0,
      icon: "utensils",
    ...
    {
      id: 7,
      title: "110 Receitas de Salgados Assados Saudáveis",
      description: "Opções mais saudáveis e igualmente deliciosas de salgados",
      image: "https://i.imgur.com/PJoqRU8.jpeg",
      originalPrice: 19.9,
      price: 0,
      icon: "utensils",
    ...
    {
      id: 8,
      title: "200 Receitas Práticas para AirFryer Saudáveis",
      description: "Receitas rápidas, saudáveis e deliciosas para sua fritadeira a ar",
      image: "https://i.imgur.com/5IEcJCz.jpeg",
      originalPrice: 19.9,
      price: 0,
      icon: "utensils",
    ...
    {
      id: 9,
      title: "30 Receitas de Cucas Caseiras Saudáveis",
      description: "Cucas tradicionais com coberturas crocantes e massas macias",
      image: "https://i.imgur.com/pqcyhGp.jpeg",
      originalPrice: 19.9,
      price: 0,
      icon: "cake",
    ...
    },
    {
      ...
      description: "Acesso exclusivo a grupo com dicas diárias, receitas novas, suporte e novidades",
      image: "https://i.imgur.com/MbWAnJm.jpeg",
      originalPrice: 19.9,
      price: 0,
      icon: "users",
            ...
            <div className="p-6 md:p-8">
              <div className="flex flex-col md:flex-row md:items-center gap-6 md:gap-10 mb-8">
                ...
                <div className="md:w-1/2 bg-amber-50 rounded-xl p-5 border border-amber-200 relative overflow-hidden">
                  ...
                  <Button
                    className="w-full bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-white py-6 sm:py-8 text-base sm:text-xl font-bold rounded-lg shadow-lg flex items-center justify-center min-h-[60px]"
                    onClick={() => {
    ...
    <div className="min-h-screen bg-[#F0F0F0] bg-[url('https://www.transparenttextures.com/patterns/flour.png')] p-4">
      ...
      <div className="max-w-4xl mx-auto">
        {showInstructions && (
          ...
          >
            <motion.div
              className="bg-white rounded-xl max-w-lg w-full p-4 shadow-2xl border-2 border-amber-300"
            ...
            >
              ...
              >
                <motion.div
                  className="bg-amber-100 rounded-full w-14 h-14 flex items-center justify-center mx-auto mb-2"
                ...
                >
                  Desbloqueie Receitas!
                </motion.h2>
              </motion.div>

              <motion.div
                className="bg-amber-50 p-3 rounded-lg border border-amber-100 mb-4"
                initial={{ opacity: 0, y: 10 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.4, delay: 0.5 }}
              >
                <p className="text-center text-amber-800">
                  Responda corretamente às perguntas para ganhar XP e desbloquear receitas exclusivas!
                </p>
              </motion.div>
              ...
              >
                <Button
                  className="w-full bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-white py-5 text-lg font-bold"
          ...
          <CardContent className="p-3">
            <div className="flex items-center justify-between mb-1">
              ...
              <div className="text-xs font-medium text-amber-700">
                {xp} XP / {getXPToNextLevel()} XP
              </div>
            </div>
            <div className="relative">
              <div className="flex items-center justify-between mb-1">
                <div>
                  <span className="text-xs font-semibold inline-block py-0.5 px-1.5 uppercase rounded-full text-amber-600 bg-amber-100">
                    Progresso
                  </span>
                </div>
                    ...
                    {isCorrect && (
                      <div className="mt-4 bg-amber-100 p-3 rounded-lg border border-amber-300">
                        <h4 className="font-bold text-amber-800 flex items-center">
                          ...
                          {correctAnswers > 0 && recipeCollections.some((r) => r.requiredCorrect === correctAnswers) ? (
                            <span>Nova Receita Desbloqueada!</span>
                          ) : (
                            <span>Bônus Desbloqueado!</span>
                          )}
                        </h4>
                        {correctAnswers > 0 && recipeCollections.some((r) => r.requiredCorrect === correctAnswers) ? (
                          ...
                          <p className="text-amber-800">Continue acertando para desbloquear mais receitas!</p>
                        )}
                        {correctAnswers > 0 && recipeCollections.some((r) => r.requiredCorrect === correctAnswers) && (
                          <Button
                            variant="outline"
          ...
          <TabsContent value="recipes" className="space-y-4">
            <div className="bg-amber-50 border border-amber-200 p-4 rounded-md mb-4">
              ...
              <p className="text-sm">
                ...
                você acertar, mais receitas e bônus grátis serão desbloqueadas!
              </p>
            </div>
                ...
                <CardContent className="space-y-4 p-6">
                  ...
                  >
                    ...
                    <p className="text-sm text-green-700 text-center mb-3">
                      Responda mais perguntas para subir de nível e desbloquear mais receitas e dicas
                      exclusivas.
                    </p>
                  ...
                  <>
                    ...
                    >
                      ...
                      <ul className="mt-4 space-y-3">
                        {[
                          ...
                          {
                            icon: "users",
                            title: "Acesso ao Grupo VIP de REceitas",
                            desc: "Aprenda diretamente com chefs profissionais",
                          },
                          {
                            icon: "trophy",
                    ...
                    >
                      <h3 className="font-bold text-amber-800 flex items-center gap-2">
                        ...
                        + Todos os bônus e truques desbloqueados!
                      </h3>
      ...
      {/* Adicionar div de espaço em branco no final */}
